...
import PasswordRetakePage from './PasswordRetakePage';
            ...
            <View style={styles.wrapper}>
                ...
                <View style={styles.container}>
                    <IconTextInput
                        ...
                        autoFocus={true}
                        beforeComponent={
                            <Icon ref={(icon) => this.icons[0] = icon} name="ios-phone-portrait-outline" size={25} color="#ccc" />
                        }
